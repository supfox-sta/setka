...
Этот проект является фанатской инициативой, не связанной с ВКонтакте или его материнской компанией VK Ltd. Он построен с использованием PHP и современных веб-технологий для воссоздания знакомого ощущения ранних социальных медиа.
